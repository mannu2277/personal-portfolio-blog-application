...
##########Update Query################
	...
	if(isset($_POST['banner_update']))
	{
       		...
       		$query="UPDATE `$page` SET `id`='".$did."' ,`introduction`='".$introduction."'  WHERE `id`='".$did."'";
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Update Intoduction about the Skills</h3>
              </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Edit Intoduction about the Skills</h2>
                  ...
                  <div class="x_content">
                    <form id="demo-form2" class="form-horizontal form-label-left" method="post" enctype="multipart/form-data">
                       <div class="form-group">
						...
						<div class="form-group"  >
							 <label for="discription">Edit Introductory Content</label> 
							 <input type="text" name="introduction" class="form-control" value="<?php echo $res3['introduction'];?>">
