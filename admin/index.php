...
<html lang="en">
  <head>
    ...
    <title>CV Forum Admin Login</title>
...
<div class="col-sm-12">
 <!-- top tiles -->
           ...
           <center>   <p style="font-size:25px;color:white"><b style="text-transform:">CV Forum</b></p>
                  
           </center>
       
        
      <center> <h3 style="font-size:25px;color:white">Content Management System/Admin Panel</h3></center>
      ...
      <div class="login_wrapper">
        ...
        <div class="clearfix"></div>
          ...
          <div class="text-center"><?php echo @$wrong_id_pw;?></div>
                <p class="change_link"><a href="https://www.linkedin.com/in/
mannu-kumar-7a007015a
">Developed by <b>Mannu Kumar, S/O Arun Kumar Choudhary </b>  </a></p>
