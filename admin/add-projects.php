...
<script>
  ...
  <body class="nav-md">
	...
	{
       		$query="INSERT INTO `projects`(`id`,`fafaicons`,`name`,`category`,`status`,`link`,`year`,`year2`,`description`) VALUES ('','".$fafaicons."','".$name."','".$category."','".$status."','".$link."','".$year."','".$year2."','".$description."')";
          ...
          <div class="">
            ...
            <div class="row" style="margin:auto 0px">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h3><b>Add Ongoing/Completed Projects</b></h3>
                  ...
                  <div class="x_content">
                    ...
                    <form id="demo-form2" class="form-horizontal form-label-left" method="post" enctype="multipart/form-data">
                      <div class="form-group">
						...
						<div class="form-group"  >
							 <label for="discription">Enter Name of The Project </label> 
							 <input type="text" name="name" class="form-control" id="s2" oninput="return validate()" >
							  
						</div>
              <div class="form-group"  >
               <label for="discription">Enter Project Category </label> 
               <input type="text" name="category" class="form-control" id="s2" oninput="return validate()" >
                
            </div>
						
						
						<div class="form-group"  >
							 <label for="discription">Select Project Status</label> 
							 <select name="status" class="form-control">
               <option value="Status not Available">
                 Select Status
               </option>
               <option value="Completed">
                 Completed
               </option>
               <option value="Undergoing">
                 Undergoing
               </option>
               <option value="Others">
                 Others
						...
						<div class="form-group"  >
               <label for="discription">Enter Project Url (if available otherwise NA)</label> 
               <input type="text" name="link" class="form-control"  >
                
            </div>
            <div class="form-group"  >
               <label for="discription">Enter Starting Year  </label> 
               <input type="text" name="year" class="form-control"  >
                
            </div>
						<div class="form-group"  >
               <label for="discription">Enter Year of Completion  </label> 
            ...
            <div class="form-group"  >
             ...
             <div class="col-md-12 col-sm-12 col-xs-12">
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        <thead>
                          <tr class="headings">
                            ...
                            <th class="column-title">Project Category</th>
                            <th class="column-title">Project Status</th>
                            <th class="column-title">Project Link/Url</th>
                            <th class="column-title">Starting Year</th>
                            <th class="column-title">Year of Completion</th>
              ...
              ?>
                ...
                <td class=" "><?php echo $res3['status'];?></td>
                <td class=" "><?php echo $res3['link'];?></td>
                <td class=" "><?php echo $res3['year'];?></td>
                <td class=" "><?php echo $res3['year2'];?></td>
