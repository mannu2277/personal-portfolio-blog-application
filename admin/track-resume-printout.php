...
##########Delete Query################
	...
	{
		$did=$_GET['did'];
		$query="DELETE FROM `track_resume_printout` WHERE `id`='".$did."'";
	...
	if(isset($_POST['multi_del']))
	{
		...
		{
			$query="DELETE FROM `track_resume_printout` WHERE `id`='".$value."'";
          ...
          <div class="">
            ...
            <div class="row">
             <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Track Resume Printout</small></h2>
				    ...
				    <form action="" method="post">
                      <table class="table table-striped jambo_table bulk_action">
                        <thead>
                         ...
                         <tbody>
						 <?php
                                    $q1="SELECT * FROM `track_resume_printout`";
                           ...
                           <tr class="even pointer">
							...
							<td width="20%"><?php echo $res3['user'];?></td>
