...
{	
	...
	{
       		$query="INSERT INTO `cont_details`(`id`,`email`,`phone`,`address`) VALUES ('','".$email."','".$phone."','".$address."')";
          ...
          <div class="">
            ...
            <div class="row" style="margin:auto 0px">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h3><b>Add Contacts Details</b></h3>
            ...
            <div class="form-group"  >
               <label for="discription">Enter Address</label> 
             ...
             <div class="col-md-12 col-sm-12 col-xs-12">
                  ...
                  <div class="x_content">
                   <div class="table-responsive">
                      <table class="table table-striped jambo_table bulk_action">
                        ...
                        <tbody>
						 <?php
                                    $q1="SELECT * FROM `cont_details` ORDER BY `id` desc";
                ...
                <td class=" "><?php echo $res3['address'];?></td>
								...
								<td class=" "><a class="btn btn-primary" href="edit-contact-details.php?did=<?php echo $res3['id'];?>&action=edit&page=cont_details"><i class="fa fa-edit"></i>Edit</a></td>
								<td class=" "><a onclick="return confirm('Are you sure?')" class="btn btn-round btn-danger" style="color:#fff;" href="?did=<?php echo $res3['id'];?>&action=delete&page=cont_details">Delete</td>
						    </tr>
