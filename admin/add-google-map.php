...
{	
	...
	{
       		$query="INSERT INTO `google_map`(`id`,`iframe_code`,`location`) VALUES ('','".$iframe_code."','".$location."')";
                  ...
                  <div class="x_content">
                    ...
                    <form id="demo-form2" class="form-horizontal form-label-left" method="post" enctype="multipart/form-data">
                      <div class="form-group">
						...
						<div class="form-group"  >
							 <label for="discription">Enter Location </label> 
							 <input type="text" name="location" class="form-control"   >
							  <!--<p class="help-block"><?php echo @$empty;?></p>-->
						</div>
            <div class="form-group"  >
               <label for="discription">Enter Location </label> 
               <textarea rows="10" name="iframe_code" class="form-control" ></textarea>
            </div>
                  ...
                  <div class="x_content">
                   <div class="table-responsive">
                      <table class="table table-striped jambo_table bulk_action">
                        ...
                        <tbody>
						 <?php
                                    $q1="SELECT * FROM `google_map` ORDER BY `id` DESC ";
                            ...
                            <tr class="even pointer">
								...
								<td class=" "><?php echo $res3['location'];?></td>
								<td class=" ">
          
                  <?php echo $res3['iframe_code'];?>
                </td>
									
				                
								<td class=" "><a class="btn btn-primary" href="edit-fafaicons.php?did= <?php echo $res3['id'];?>&action=edit&page=google_map"><i class="fa fa-edit"></i>Edit</a></td>
								<td class=" "><a onclick="return confirm('Are you sure?')" class="btn btn-round btn-danger" style="color:#fff;" href="?did=<?php echo $res3['id'];?>&action=delete&page=google_map">Delete</td>
						    </tr>
						    <?php
								   }
								   ?>
