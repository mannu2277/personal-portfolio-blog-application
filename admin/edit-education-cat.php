...
##########Update Query################
	...
	if(isset($_POST['banner_update']))
	{
       		...
       		$query="UPDATE `$page` SET `id`='".$did."' ,`edu_cat`='".$edu_cat."'  WHERE `id`='".$did."'";
			mysqli_query($dbcon,$query) or die(mysqli_error());
			$empty="File Updated Successfully";
			echo'<script>
			alert("Updated Successfully");
			window.location.href="add-education-cat.php";
			</script>';
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Update Education Category</h3>
              </div>
              </div>
            </div>
                    ...
                    <form id="demo-form2" class="form-horizontal form-label-left" method="post" enctype="multipart/form-data">
                       <div class="form-group">
						...
						<div class="form-group"  >
							 ...
							 <input type="text" name="edu_cat" class="form-control" value="<?php echo $res3['edu_cat'];?>">
