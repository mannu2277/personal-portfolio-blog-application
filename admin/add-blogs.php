...
<?php include 'header.php';?>
  <body class="nav-md">
	...
	{
		$path = "blog-images/" . $_FILES['image']['name'];
    	move_uploaded_file($_FILES['image']['tmp_name'], $path);
	if ($_FILES['image']['tmp_name'] != '' ) 
  {
       		$query="INSERT INTO `blog` (`id`,`image`,`date`,`title`,`description`,`author`,`visibility`) VALUES ('','".$path."','".$date."','".$title."','".$description."','".$author."','".$visibility."')";
			mysqli_query($dbcon,$query) or die(mysqli_error($dbcon));
			$empty="Blog Posted Successfully";
    }	
	else
	{	
                  ...
                  <div class="x_content">
                    ...
                    <form id="demo-form2" class="form-horizontal form-label-left" method="post" enctype="multipart/form-data">
                      <div class="form-group">
						...
						<div class="form-group"  >
							 <label for="discription">Enter Date</label> 
							 <input type="date" name="date" class="form-control"  >
							 
						</div>
            <div class="form-group"  >
               <label for="discription">Enter Post Title</label> 
               <input type="text" name="title" class="form-control"  >
                
            </div>
            <div class="form-group"  >
               <label for="discription">Post Description</label> 
               <input type="text" name="description" class="form-control"  >
            </div>
						<div class="form-group"  >
               <label for="discription">Enter Author Name</label> 
               <input type="text" name="author" class="form-control" value="Mannu Kumar"  >
                
            </div>
            <div class="form-group">
              <label>Select Blog Visibility</label>
              <br>
            <label>
              <input type="radio" name="visibility" value="Public" > Public (Can be seen without Sign In)
              &nbsp;
              &nbsp;
              <input type="radio" name="visibility" value="Protected" > Protected (Cannot be seen without Sign In)
					 ...
					 <div class="ln_solid"></div>
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <button type="submit" class="btn btn-success" name="add_image">Post Blog</button>
             ...
             <div class="col-md-12 col-sm-12 col-xs-12">
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        <thead>
                          <tr class="headings">
                            ...
                            <th class="column-title">Blog Image</th>
                            <th class="column-title">Posted on</th>
                            <th class="column-title">Blog Title</th>
                            <th class="column-title">Description</th>
                            <th class="column-title">Posted by</th>
                ...
                <td class=" "><?php echo $res3['author'];?></td>
                <td class=" "><?php echo $res3['visibility'];?></td>
