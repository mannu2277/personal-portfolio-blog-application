...
##########Update Query################
	...
	if(isset($_POST['banner_update']))
	{
       		...
       		$query="UPDATE `$page` SET `id`='".$did."' ,`icon`='".$icon."' WHERE `id`='".$did."'";
			mysqli_query($dbcon,$query) or die(mysqli_error());
			$empty="File Updated Successfully";
			echo'<script>
			alert("Updated Successfully");
			window.location.href="add-fafaicons.php";
			</script>';
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Update Font-Awsome Icons</h3>
              </div>
              </div>
            </div>
                  ...
                  <div class="x_content">
                    <form id="demo-form2" class="form-horizontal form-label-left" method="post" enctype="multipart/form-data">
                       <div class="form-group">
						...
						<?php
                                    $q3="SELECT * FROM `fafa_icons` WHERE `id`='".$did."'";
						...
						<div class="form-group"  >
							 <label for="discription">Edit Icons</label> 
							 <input type="text" name="icon" class="form-control" value="<?php echo $res3['icon'];  ?>">
							<span >
          <i class="<?php echo $res3['icon'];?> " style="zoom:200%">&nbsp;&nbsp;&nbsp;  </i><?php echo $res3['icon'];?>       
              </span>
						</div>
