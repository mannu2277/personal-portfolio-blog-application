...
##########Update Query################
	...
	if ($_FILES['image']['tmp_name'] != '' ) {
       		$query="UPDATE `$page` SET `id`='".$did."', `image`='".$path."' ,`href`='".$href."'  WHERE `id`='".$did."'";
			mysqli_query($dbcon,$query) or die(mysqli_error());
			$empty="File Updated Successfully";
			echo'<script>
			alert("Updated Successfully");
			window.location.href="add-photos.php";
			</script>';
			
			
    }	
	if ($_FILES['banner_image']['tmp_name'] == '' ) {
       		$query="UPDATE `$page` SET `id`='".$did."' ,`href`='".$href."'  WHERE `id`='".$did."'";
			mysqli_query($dbcon,$query) or die(mysqli_error());
        ...
        <div class="right_col" role="main">
          <div class="">
            ...
            <div class="row">
             ...
             <div class="col-sm-4">
             <div class="form-group">
              <label for="first-name">Select File<span class="required">
              </label>
            ...
            <div class="col-sm-4">
             <figure>
               <img src="<?php echo $res3['image'];  ?>" class="file">
               <figcaption>
                 Current Image
                 <br>
                 <?php echo $res3['image'];  ?>
						...
						<div class="form-group"  >
							 <label for="discription">Edit Hyperlink </label> 
							 <input type="text" name="href" class="form-control" placeholder="eg. index.php" value="<?php echo $res3['href'];?>" >
