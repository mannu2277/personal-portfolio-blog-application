...
##########Update Query################
	...
	if(isset($_POST['banner_update']))
	{
       		...
       		$query="UPDATE `$page` SET `id`='".$did."' ,`fafaicons`='".$fafaicons."',`name`='".$name."',`category`='".$category."',`year`='".$year."',`description`='".$description."',`year2`='".$year2."',`status`='".$status."',`link`='".$link."' WHERE `id`='".$did."'";
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Update Ongoing/Completed Projects</h3>
              </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Edit Ongoing/Completed Projects</h2>
               ...
               <select name="fafaicons" class="form-control">
                 <option selected="selected" value="<?php echo $res3['fafaicons'];   ?>"><?php echo $res3['fafaicons'];   ?>
						...
						<div class="form-group"  >
							 <label for="discription">Edit Projects Name</label> 
							 <input type="text" name="name" class="form-control" value="<?php echo $res3['name'];?>">
							  
						</div>
            <div class="form-group"  >
               <label for="discription">Edit Project Category</label> 
               <input type="text" name="category" class="form-control" value="<?php echo $res3['category'];?>">
                
            </div>
            <div class="form-group"  >
               <label for="discription">Change Project Status</label> 
               <select name="status" class="form-control">
               <option disabled="disabled" value="<?php echo $res3['status'];?>">
                <?php echo $res3['status'];?>
               </option>
           ...
           <div class="form-group"  >
               <label for="discription">Edit Project Url/Link</label> 
               <input type="text" name="link" class="form-control" value="<?php echo $res3['link'];?>">
                
          </div>
          <div class="form-group"  >
               <label for="discription">Edit Starting Year</label> 
               <input type="text" name="year" class="form-control" value="<?php echo $res3['year'];?>">
                
          </div>
          <div class="form-group"  >
               <label for="discription">Edit Year of Completion</label> 
               <input type="text" name="year2" class="form-control" value="<?php echo $res3['year2'];?>">
