...
##########Update Query################
	...
	if(isset($_POST['banner_update']))
	{
       		...
       		$query="UPDATE `$page` SET `id`='".$did."' ,`email`='".$email."',`phone`='".$phone."',`address`='".$address."'  WHERE `id`='".$did."'";
			mysqli_query($dbcon,$query) or die(mysqli_error());
			$empty="File Updated Successfully";
			echo'<script>
			alert("Updated Successfully");
			window.location.href="add-contact-details.php";
			</script>';
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
               ...
               <input type="number" name="phone" class="form-control" value="<?php echo $res3['phone'];?>">
                
            </div><div class="form-group"  >
               <label for="discription">Edit Address</label> 
               <input type="text" name="address" class="form-control" value="<?php echo $res3['address'];?>">
