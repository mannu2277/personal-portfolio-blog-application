...
##########Update Query################
	...
	if(isset($_POST['banner_update']))
	{
       		...
       		$query="UPDATE `$page` SET `id`='".$did."' ,`heading`='".$heading."',`sub_heading`='".$sub_heading."',`description`='".$description."'  WHERE `id`='".$did."'";
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Update Content about Skills</h3>
              </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Edit  Content about Skills</h2>
                  ...
                  <div class="x_content">
					...
					<div class="form-group"  >
               <label for="discription">Edit Sub-Heading</label> 
               <input type="text" name="sub_heading" class="form-control" value="<?php echo $res3['sub_heading'];?>">
