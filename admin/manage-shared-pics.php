...
##########Delete Query################
  ...
  {
    $did=$_GET['did'];
    $query="DELETE FROM `share_pics` WHERE `id`='".$did."'";
          ...
          <div class="">
            ...
            <div class="row">
             <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>View Shared Photos</small></h2>
            ...
            <form action="" method="post">
              ...
              <td width="20%"><?php echo $res3['username'];?></td>
              <td width="20%"><?php echo $res3['phone'];?></td>
              <td width="20%"><img src="../<?php echo $res3['image'];?>" style="height: 100px;width: 100px" ></td>
